#!/bin/bash
# =============================================================================
# GPT-4o-mini via GitHub Copilot — KernelGYM Evaluation Script
# =============================================================================
# Uses GitHub Copilot API (api.githubcopilot.com) to access GPT-4o-mini
# for Triton kernel generation. Requires an active OpenCode OAuth token
# cached at ~/.local/share/opencode/auth.json.
#
# GPT-4o-mini is a free model on Copilot — good for validation before
# running expensive models at scale.
# NOTE: gpt-4.1-mini does NOT exist on Copilot API. Use gpt-4o-mini instead.
#
...
# GPT-4o-mini is free and fast — can use higher concurrency
